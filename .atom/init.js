...
function createTestMockFile() {
    const mock_path = '/Users/oki.suguru/dev-environment/core/tests/unit/mockObjects/MyClass/';
    const { File } = require('atom');
    // Create file
    const myFile = new File(mock_path + 'file_name' + '.php');
    myFile.create();
    myFile.onDidRename();
}
...
atom.commands.add("atom-text-editor", {
  ...
  // "commandCreateTestMock": createTestMockFile,
